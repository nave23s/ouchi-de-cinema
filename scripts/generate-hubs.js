...
const GENRE_DESC = {
  ...
  '犯罪': '犯罪映画の音楽は、緊張と解放のコントロールが命です。静寂と轟音の使い分けが観客の息を止める。犯罪映画の劇伴に潜む心理的駆け引きを音の視点で語ります。',
...
const GENRE_FAQ = {
  ...
  '犯罪': [
    { q: '犯罪映画の音楽の特徴は？', a: '犯罪映画の劇伴は静寂と轟音の使い分けが命。緊張感を高める低音と、解放感をもたらす主題歌の対比が映画の質を決めます。' },
    { q: 'このサイトの犯罪映画レビューの特徴は？', a: '音が犯罪をどう演出するかに着目。劇伴・効果音・沈黙の使い方から犯罪映画の本質を語ります。' },
  ],
  'サスペンス': [
...
function main() {
  ...
  const MIN_WORKS = 3;
  const TARGETS = ['ドラマ','アクション','ロマンス','コメディ','SF','アドベンチャー','犯罪','サスペンス'];
