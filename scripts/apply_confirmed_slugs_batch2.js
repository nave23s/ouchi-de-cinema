'use strict';
// confirmed_slugs_batch2.json (84件) を movies.json に反映する
...
function main() {
  ...
  const confirmed = JSON.parse(fs.readFileSync(path.join(ROOT, 'confirmed_slugs_batch2.json'), 'utf8'));

  // バックアップ
  const backupPath = path.join(ROOT, 'movies.json.backup-2026-06-13');
